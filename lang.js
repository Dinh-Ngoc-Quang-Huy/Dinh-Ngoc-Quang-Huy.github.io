...
const translations = {
  ...
  "hero.sub":      { vi: "Đây là website portfolio của mình, cảm ơn các bạn đã ghé tham. Chúc các bạn một ngày tốt lành!",
  ...
  "about.phone":      { vi: "Mobile/Zalo: 083.442.8402", en: "Mobile/Zalo: 083.442.8402" },
  "about.email":      { vi: "Email: Dinhngocquanghuy99@gmail.com", en: "Email: Dinhngocquanghuy99@gmail.com" },
  "about.facebook":   { vi: "Facebook: Quang Huy", en: "Facebook: Quang Huy" },
  ...
  // ── Project Names ──
  "project.ubnd":       { vi: "Ủy Ban Nhân Dân Thành Phố Hồ Chí Minh",
  ...
  "project.nhatha":      { vi: "Kiểm Định Khách Sạn Nhật Hạ", en: "Nhat Ha Hotel Inspection" },
  ...
  // ── Footer ──
  "footer.copy":        { vi: "Đinh Ngọc Quang Huy", en: "Dinh Ngoc Quang Huy" },
  ...
  "phuocthinh.desc":       { vi: "Dự án xin giấy phép sửa đổi và quy hoạch 1/2000 quy hoạch 1/500 của Khu Dân Cư Phước Thịnh, Quận 12, TP.HCM.", en: "Project for modify license and 1/2000, 1/500 master plan of Phuoc Thinh Residential Area, District 12, HCMC." },
  ...
  "sholi.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "orista.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "phapson.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "kyco.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "tanbinh.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "nguyenhuutho.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "tranquoctoan.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "binhthuan.task_type":  { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and calculation models of the design consultant. Review drawings against other disciplines to check for clashes. Review drawings to ensure adequate conditions, profile components, and compliance with applicable standards and regulations." },
  ...
  "mavin.point2": { vi: "Công trình có tầm quan trọng đặc biệt và là kho chứa lớn của tỉnh.", en: "A project of special importance as it is a large warehouse for the province." },
  ...
  // ── Project: TDS ──
  "tds.page_title": { vi: "Tầm Dung Sơn | Quang Huy", en: "Tam Dung Son | Quang Huy" },
  ...
  "vyda.task_type": { vi: "Thẩm tra kết quả tính toán, mô hình tính toán của đơn vị tư vấn thiết kế. Rà soát kiểm tra bản vẽ đối chiếu với các bộ môn để kiểm tra va chạm. Rà soát kiểm tra bản vẽ đảm bảo đủ điều kiện, thành phần hồ sơ và đảm bảo theo tiêu chuẩn, quy chuẩn áp dụng.", en: "Verify calculation results and structural models of the design consultant. Review drawings against other disciplines to check for clashes. Evaluate drawings for completeness, document composition, and compliance with applicable standards." },
  ...
  // ── Project: UBND ──
  "ubnd.page_title": { vi: "UBND TP.HCM | Quang Huy", en: "HCMC People's Committee | Quang Huy" },
  "ubnd.title":      { vi: "Ủy Ban Nhân Dân Thành Phố Hồ Chí Minh", en: "Ho Chi Minh City People's Committee" },
  "ubnd.desc":       { vi: "Dự án kiểm định và thiết kế kết cấu công trình Ủy Ban Nhân Dân Và Hội Đồng Nhân Dân Thành Phố Hồ Chí Minh. Đây là một trong những công trình trọng điểm mà mình đã tham gia.", en: "Structural inspection and design project for Ho Chi Minh City People's Committee and People's Council. This is one of the key projects I participated in." },
  "ubnd.role":       { vi: "Kỹ Sư Thiết Kế Kết Cấu", en: "Structural Design Engineer" },
  "ubnd.task_type":  { vi: "Khảo sát hiện trạng, kiểm tra và phối hợp cùng công ty kiểm định để xác định vị trí sửa chữa cải tạo, kiểm tra khả năng chịu lực chính của công trình. Kiểm tra khả năng sử dụng sau khi đã cải tạo, đề xuất phương án cải tạo và sửa chữa tối ưu đảm bảo về mặt kỹ thuật cũng như về mặt mỹ quan.", en: "Survey current conditions, test, and coordinate with the inspection company to identify repair and renovation locations, check the main load-bearing capacity of the building. Inspect usability after renovation, propose optimal repair and renovation plans ensuring technical and aesthetic requirements." },
  "ubnd.point1":     { vi: "Thiết kế kết cấu công trình trọng điểm.", en: "Structural design of key construction." },
  "ubnd.point2":     { vi: "Công trình cấp 1 với quy mô và tầm quan trọng cấp Quốc Gia.", en: "Grade 1 construction with national-level scale and importance." },
  "ubnd.point3":     { vi: "Là di sản của TP.HCM.", en: "A heritage of HCMC." },
  "ubnd.point4":     { vi: "Tính toán và kiểm tra kết cấu theo TCVN.", en: "Calculate and check structure according to TCVN." },
  "ubnd.point5":     { vi: "Phối hợp với đội ngũ kiến trúc và MEP, phòng cháy chữa cháy.", en: "Coordinate with architectural, MEP, and firefighting teams." },

  // ── Project: METRI ──
  "metri.page_title": { vi: "Villa Mễ Trì | Quang Huy", en: "Me Tri Villa | Quang Huy" },
  "metri.title":      { vi: "Villa Mễ Trì, Huyện Đông Anh, TP. Hà Nội", en: "Me Tri Villa, Dong Anh District, Hanoi" },
  "metri.desc":       { vi: "Dự án kiểm định và thiết kế kết cấu Công trình Villa Mễ Trì, Huyện Đông Anh, TP. Hà Nội. Đây là một trong những Công trình trọng điểm mà mình đã tham gia tại công ty TTAD.", en: "Structural inspection and design project for Me Tri Villa, Dong Anh District, Hanoi. This is one of the key projects I participated in at TTAD company." },
  "metri.role":       { vi: "Kỹ Sư Thiết Kế Kết Cấu", en: "Structural Design Engineer" },
  "metri.task_type":  { vi: "Khảo sát hiện trạng, kiểm tra và phối hợp cùng công ty kiểm định để xác định vị trí sửa chữa cải tạo, kiểm tra khả năng chịu lực chính của công trình. Kiểm tra khả năng sử dụng sau khi đã cải tạo, đề xuất phương án cải tạo và sửa chữa tối ưu đảm bảo về mặt kỹ thuật cũng như về mặt mỹ quan.", en: "Survey current conditions, test, and coordinate with the inspection company to identify repair and renovation locations, check the main load-bearing capacity. Inspect usability after renovation, propose optimal repair and renovation plans." },
  "metri.point1":     { vi: "Thiết kế kết cấu công trình trọng điểm.", en: "Structural design of key construction." },
  "metri.point2":     { vi: "Công trình cấp 1 với quy mô và tầm quan trọng cấp Quốc Gia.", en: "Grade 1 construction with national-level scale and importance." },
  "metri.point3":     { vi: "Là di sản của TP.HCM.", en: "A heritage of HCMC." },
  "metri.point4":     { vi: "Tính toán và kiểm tra kết cấu theo TCVN.", en: "Calculate and check structure according to TCVN." },
  "metri.point5":     { vi: "Phối hợp với đội ngũ kiến trúc và MEP, phòng cháy chữa cháy.", en: "Coordinate with architectural, MEP, and firefighting teams." },

  // ── Project: KHANH HAI ──
  "khanhhai.page_title": { vi: "Khánh Hải | Quang Huy", en: "Khanh Hai | Quang Huy" },
  "khanhhai.title":      { vi: "Khu Du Lịch Khách Sạn Và Giải Trí Phức Hợp Khánh Hải", en: "Khanh Hai Tourism, Hotel & Entertainment Complex" },
  "khanhhai.desc":       { vi: "Dự án kiểm định và thiết kế kết cấu Du lịch Khu Du Lịch Khách Sạn Và Giải Trí Phức Hợp Khánh Hải. Đây là một trong những Du lịch trọng điểm mà mình đã tham gia tại công ty TTAD.", en: "Structural inspection and design project for Khanh Hai Tourism, Hotel & Entertainment Complex. This is one of the key tourism projects I participated in at TTAD company." },
  "khanhhai.role":       { vi: "Kỹ Sư Thiết Kế Kết Cấu", en: "Structural Design Engineer" },
  "khanhhai.task_type":  { vi: "Khảo sát hiện trạng, kiểm tra và phối hợp cùng công ty kiểm định để xác định vị trí sửa chữa cải tạo, kiểm tra khả năng chịu lực chính của công trình. Kiểm tra khả năng sử dụng sau khi đã cải tạo, đề xuất phương án cải tạo và sửa chữa tối ưu đảm bảo về mặt kỹ thuật cũng như về mặt mỹ quan.", en: "Survey current conditions, test, and coordinate with the inspection company to identify repair and renovation locations, check the main load-bearing capacity. Inspect usability after renovation, propose optimal repair and renovation plans." },
  "khanhhai.point1":     { vi: "Thiết kế kết cấu công trình trọng điểm.", en: "Structural design of key construction." },
  "khanhhai.point2":     { vi: "Công trình cấp 1 với quy mô và tầm quan trọng cấp Quốc Gia.", en: "Grade 1 construction with national-level scale and importance." },
  "khanhhai.point3":     { vi: "Là di sản của TP.HCM.", en: "A heritage of HCMC." },
  "khanhhai.point4":     { vi: "Tính toán và kiểm tra kết cấu theo TCVN.", en: "Calculate and check structure according to TCVN." },
  "khanhhai.point5":     { vi: "Phối hợp với đội ngũ kiến trúc và MEP, phòng cháy chữa cháy.", en: "Coordinate with architectural, MEP, and firefighting teams." },

  // ── Project: NHAT HA ──
  "nhatha.page_title": { vi: "Khách Sạn Nhật Hạ | Quang Huy", en: "Nhat Ha Hotel | Quang Huy" },
  "nhatha.title":      { vi: "Kiểm Định Khách Sạn Nhật Hạ", en: "Nhat Ha Hotel Structural Inspection" },
  "nhatha.desc":       { vi: "Dự án kiểm định kết cấu Khách Sạn Nhật Hạ. Đây là một trong những công trình kiểm định khách sạn mà mình đã tham gia tại công ty TTAD.", en: "Structural inspection project for Nhat Ha Hotel. This is one of the hotel inspection projects I participated in at TTAD company." },
  "nhatha.location":   { vi: "Thành Phố Hồ Chí Minh", en: "Ho Chi Minh City" },
  "nhatha.role":       { vi: "Kỹ Sư Thiết Kế Kết Cấu", en: "Structural Design Engineer" },
  "nhatha.task_type":  { vi: "Khảo sát hiện trạng, kiểm tra và phối hợp cùng công ty kiểm định để xác định vị trí sửa chữa cải tạo, kiểm tra khả năng chịu lực chính của công trình. Kiểm tra khả năng sử dụng sau khi đã cải tạo, đề xuất phương án cải tạo và sửa chữa tối ưu đảm bảo về mặt kỹ thuật cũng như về mặt mỹ quan.", en: "Survey current conditions, test, and coordinate with the inspection company to identify repair and renovation locations, check the main load-bearing capacity. Inspect usability after renovation, propose optimal repair and renovation plans ensuring technical and aesthetic requirements." },
  "nhatha.point1":     { vi: "Kiểm định kết cấu công trình khách sạn.", en: "Structural inspection of the hotel building." },
  "nhatha.point2":     { vi: "Tính toán và kiểm tra kết cấu theo TCVN.", en: "Calculate and check structure according to TCVN." },
  "nhatha.point3":     { vi: "Phối hợp với đội ngũ kiến trúc và MEP, phòng cháy chữa cháy.", en: "Coordinate with architectural, MEP, and firefighting teams." },
  "nhatha.point4":     { vi: "Đề xuất phương án gia cường sửa chữa tối ưu.", en: "Propose optimal repair and reinforcement plans." },
  // ── Software Details ──
  ...
  "qhtools.feat8": { vi: "Phần mềm vẽ móng cọc tự động hình dạng bất kỳ.", en: "Auto-draw pile foundations of any shape." },
